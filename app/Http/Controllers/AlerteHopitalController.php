...
class AlerteHopitalController extends Controller
{
    //
    public function index()
    {
        ...
        return view('alerteHopital', compact('citoyen'));
    }
   ...
   public function store(Request $request)
{
    ...
    $request->validate([
        ...
        'media_vocal' => 'nullable|string', // Base64 audio
    ]);
    ...
    if ($request->media_vocal) {
        ...
        // Récupère l'extension depuis le Data URI
