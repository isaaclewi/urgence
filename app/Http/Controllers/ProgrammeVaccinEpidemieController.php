...
class ProgrammeVaccinEpidemieController extends Controller
{
    //
    public function index()
{
    $programmes = \App\Models\MonProgrammeVaccin::where('categorie', 'epidemie')->get();
    ...
    return view('vaccinationEpidemie', compact('programmes'));
}
}
