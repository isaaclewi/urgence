            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2 flex items-center gap-3">
                        ...
                        Programmes de Vaccination — Épidémies
                    </h1>
                    <p class="text-gray-600">Campagnes de vaccination liées aux épidémies</p>
                </div>
        ...
        <div class="bg-gradient-to-r from-red-500 to-orange-500 rounded-xl p-6 mb-8 text-white animate-fade-in">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-red-100">Ces programmes de vaccination sont mis en place en réponse aux épidémies. Ils visent à protéger rapidement les populations à risque et à contenir la propagation des maladies infectieuses.</p>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="programme-card card-hover animate-slide-up" style="animation-delay: {{ $index * 0.1 }}s">
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <span class="category-badge">{{ ucfirst($programme->categorie) }}</span>
                            </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center gap-2 text-sm">
                                    ...
                                    <span class="font-semibold text-gray-900">{{ $programme->date_debut->format('d/m/Y') }} - {{ $programme->date_fin->format('d/m/Y') }}</span>
                                </div>
                                ...
                                <div class="bg-gray-50 rounded-lg p-3 mt-4">
                                    ...
                                    <p class="font-semibold text-gray-900 text-sm mt-1">{{ $programme->organisme_resp }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="col-span-full bg-white rounded-2xl shadow-lg p-12 text-center">
                        ...
                        <p class="text-gray-400">Il n'y a actuellement aucun programme de vaccination lié à une épidémie ou pandémie</p>
                    </div>
                @endforelse
            </div>
        </div>
