...
<head>
    ...
    <style>
        ...
        .category-badge {
            ...
            text-transform: uppercase; letter-spacing: .5px; z-index: 10;
        }
        ...
        #pwa-fab:hover {
            ...
            box-shadow: 0 14px 36px rgba(16,185,129,.6);
        }
...
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <section class="mb-12">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                <div class="card-hover bg-white rounded-xl shadow-lg overflow-hidden h-80 relative group">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent z-10">
                        ...
                        <p class="text-white/90 text-sm">Signalez rapidement les situations nécessitant une ambulance ou des secours</p>
                    </div>
                </div>
                ...
                <div class="card-hover bg-white rounded-xl shadow-lg overflow-hidden h-80 relative group">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent z-10">
                        ...
                        <p class="text-white/90 text-sm">Alertez les sapeurs-pompiers pour tout incendie ou accident grave</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="card-hover bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-5">
                        <span class="inline-block bg-blue-500 text-white text-xs font-bold px-3 py-1 rounded mb-3">POLICE</span>
                        <p class="text-gray-500 text-sm mb-2">7 janvier 2026</p>
                        <h3 class="text-gray-900 font-bold text-lg mb-2 hover:text-blue-600 transition">Police & Sécurité</h3>
                        <p class="text-gray-600 text-sm">Signalez toute activité suspecte nécessitant l'intervention des forces de l'ordre</p>
                    </div>
                </div>
                ...
                <div class="card-hover bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-5">
                        <span class="inline-block bg-yellow-500 text-white text-xs font-bold px-3 py-1 rounded mb-3">ROUTES</span>
                        <p class="text-gray-500 text-sm mb-2">7 janvier 2026</p>
                        <h3 class="text-gray-900 font-bold text-lg mb-2 hover:text-blue-600 transition">Routes Urbaines</h3>
                        <p class="text-gray-600 text-sm">Alertez sur les dangers routiers et infrastructures défectueuses</p>
                    </div>
                </div>
                ...
                <div class="card-hover bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-5">
                        <span class="inline-block bg-green-500 text-white text-xs font-bold px-3 py-1 rounded mb-3">PROPRETÉ</span>
                        <p class="text-gray-500 text-sm mb-2">7 janvier 2026</p>
                        <h3 class="text-gray-900 font-bold text-lg mb-2 hover:text-blue-600 transition">Déchets & Propreté</h3>
                        <p class="text-gray-600 text-sm">Signalez les problèmes d'hygiène publique et dépôts sauvages</p>
                    </div>
                </div>
                ...
                <div class="card-hover bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-5">
                        <span class="inline-block bg-yellow-400 text-gray-900 text-xs font-bold px-3 py-1 rounded mb-3">ÉLECTRICITÉ</span>
                        <p class="text-gray-500 text-sm mb-2">7 janvier 2026</p>
                        <h3 class="text-gray-900 font-bold text-lg mb-2 hover:text-blue-600 transition">Panne Électricité</h3>
                ...
                <div class="card-hover bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-5">
                        <span class="inline-block bg-purple-500 text-white text-xs font-bold px-3 py-1 rounded mb-3">CARTE</span>
                        <p class="text-gray-500 text-sm mb-2">7 janvier 2026</p>
                        <h3 class="text-gray-900 font-bold text-lg mb-2 hover:text-blue-600 transition">Carte des Urgences</h3>
                ...
                <div class="card-hover bg-white rounded-xl shadow-md overflow-hidden">
                    <div class="image-overlay h-48">
                        <img src="https://images.unsplash.com/photo-1516321497487-e288fb19713f?w=600" alt="Info" class="w-full h-full object-cover">
                    </div>
                    <div class="p-5">
                        <span class="inline-block bg-indigo-500 text-white text-xs font-bold px-3 py-1 rounded mb-3">INFO</span>
                        <p class="text-gray-500 text-sm mb-2">7 janvier 2026</p>
                        <h3 class="text-gray-900 font-bold text-lg mb-2 hover:text-blue-600 transition">Informations Utiles</h3>
        ...
        <section class="bg-white rounded-xl shadow-lg p-8 mb-12">
            ...
            <p class="text-gray-600 mb-8">
                Vous êtes témoin d'une urgence ? Remplissez ce formulaire pour alerter rapidement les services compétents.
            </p>

            @if (session('success'))
                <div class="mb-6 p-4 bg-green-50 border border-green-200 text-green-700 rounded-lg font-semibold animate-fade-in">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <form id="alertForm" class="space-y-6" enctype="multipart/form-data" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="type_alerte" required class="w-full border-2 border-gray-200 rounded-lg px-4 py-3">
        ...
        <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                ...
                <p class="text-gray-300 leading-relaxed">
                    CongoAssist est une plateforme communautaire de signalement des urgences,
                    permettant d'alerter rapidement les services compétents pour sauver des vies.
                </p>
            </div>
            <div>
    ...
    (function () {
        ...
        // ── 3. Chrome/Edge/Android : capture l'event natif ──
        ...
        // ── 4. iOS : pas d'event natif, on affiche quand même le bouton ──
        if (isIOS) {
            fab.style.display = 'flex';
        }

        // ── 5. Masquer après installation ──
        ...
        function showGuide() {
            if (isIOS) {
                ...
                body.innerHTML    = 'Dans <strong>Chrome</strong> ou <strong>Edge</strong>, cliquez sur l\'icône <strong>⊕</strong> dans la barre d\'adresse, ou menu <strong>⋮</strong> → <strong>Installer l\'application</strong>.';
            }
